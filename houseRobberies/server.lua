...
local robbableItems = {
 ...
 [2] = {chance = 5, id = '137902532', name = 'Vintage Pistol', isWeapon = true}, -- rare
 [3] = {chance = 3, id = 'oxy', name = 'oxy', quantity = math.random(1, 3)}, -- really common
 [4] = {chance = 5, id = 'joint', name = 'joint', quantity = 1}, -- rare
 [5] = {chance = 4, id = 'goldbar', name = 'Altın Külçesi', quantity = 1}, -- rare
 [6] = {chance = 5, id = 'valuablegoods', name = 'Hurda', quantity = 1}, -- rare
 [7] = {chance = 6, id = 'advlockpick', name = 'Gelişmiş Maymuncuk', quantity = 1}, -- rare
 --[[[8] = {chance = 5, id = '10ct_gold_chain', name = '10CT Gold Chain (P)', quantity = 1}, -- rare
 [9] = {chance = 5, id = 'drill_bit', name = 'Drill Bit', quantity = 1}, -- rare
 ...
 [22] = {chance = 5, id = 'fuse', name = 'Fuse', quantity = 1}, -- rare
 [23] = {chance = 5, id = 'clutch', name = 'Clutch', quantity = 1}, -- rare
 [24] = {chance = 5, id = 'battery', name = 'Battery', quantity = 1}, -- rare
 [25] = {chance = 2, id = 'breadboard', name = 'Breadboard (P)', quantity = 1}, -- rare
 [26] = {chance = 5, id = 'white_pearl', name = 'White Pearl (P)', quantity = 1}, -- rare
 [27] = {chance = 5, id = 'coke_pooch', name = 'Bag of Coke', quantity = 1}, -- rare
 [28] = {chance = 5, id = 'xtc', name = 'X', quantity = 1}, -- rare
 [29] = {chance = 5, id = 'electronics', name = 'Electronics (P)', quantity = 1}, -- rare
 [30] = {chance = 5, id = 'electronic_kit', name = 'Electronic Kit', quantity = 1}, -- rare]]
}
 ...
 for i=1, math.random(1, 2) do
  ...
  if math.random(1, 10) >= item.chance then
   if tonumber(item.id) == 0 and not gotID[item.id] then
    ...
    TriggerClientEvent('notification', source, 'Buldun $'..item.quantity)
   elseif item.isWeapon and not gotID[item.id] then
    gotID[item.id] = true
    TriggerClientEvent("player:receiveItem",source, item.id, 1)
    TriggerClientEvent('notification', source, 'Eşya bulundu!', 2)
   elseif not gotID[item.id] then
    gotID[item.id] = true
    TriggerClientEvent("player:receiveItem",source, item.id, item.quantity)
    TriggerClientEvent('notification', source, item.id.. ' Bulundu', 2)
   end
  end
 end
end)